    ...
    def save_data(self):
        if self.review_data():
            ...
            if result:
                ...
                self.send_error_message(self, "Error", "Los cambios no se pudieron guardar. Por favor verificar los datos y que la base de datos este disponible.")


    def update_path(self):
        path_name = QFileDialog.getExistingDirectory(self, "Seleccione carpeta de descarga y lectura", "/")
