...
class Ui_Caronte(object):
    def setupUi(self, Caronte):
        ...
        sizePolicy.setHeightForWidth(self.proveedor.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, Caronte):
        Caronte.setWindowTitle(QCoreApplication.translate("Caronte", u"NICO: Descarga de Documentos Electrónicos por Correo v0.1", None))
        self.label_2.setText(QCoreApplication.translate("Caronte", u"Proveedor", None))
        self.label_3.setText(QCoreApplication.translate("Caronte", u"Desde", None))
        self.label_4.setText(QCoreApplication.translate("Caronte", u"Hasta", None))
        self.label.setText(QCoreApplication.translate("Caronte", u"N\u00famero", None))
        self.buscar.setText(QCoreApplication.translate("Caronte", u"Buscar", None))
        self.limpiar.setText(QCoreApplication.translate("Caronte", u"Limpiar", None))
        self.exportar.setText(QCoreApplication.translate("Caronte", u"Exportar", None))
    # retranslateUi
